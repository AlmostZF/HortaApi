...
public class OrderReservationEntity
{
    ...
    public static OrderReservationEntity CreateForCustomer(Guid customerId, PickupLocationEntity location, DateTime pickupDate, DateTime deadline, decimal fee)
    {
        var order = new OrderReservationEntity(location, pickupDate, deadline, fee);
        order.CustomerId = customerId;
        return order;
    }
    
    public static OrderReservationEntity CreateForGuest(string name, string email, string phone, PickupLocationEntity location, DateTime pickupDate, DateTime deadline, decimal fee)
    {
        var order = new OrderReservationEntity(location, pickupDate, deadline, fee);
    ...
    private OrderReservationEntity(PickupLocationEntity location, DateTime pickupDate, DateTime deadline, decimal fee)
    {
        Id = Guid.NewGuid();
